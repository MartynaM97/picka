(function (factory) {
  ...
  function isNumberLike(obj) {
    return (
      obj !== null &&
      obj !== undefined &&
      ((isString(obj) && isFinite(parseFloat(obj))) || isFinite(obj))
    );
  }
    ...
    forEachAncestors(
      ...
      function (el) {
        return (isEventOnSlider =
          el.id === _this.identifier &&
          !hasClass(el, _this.options.disabledClass));
      },
      true
    );
    if (isEventOnSlider) {
  ...
  Plugin.prototype._setPosition = function (pos) {
    var value, left, stickTo, stickRadius, restFromValue;
  ...
  Plugin.prototype._getRelativePosition = function (e) {
    ...
    if (typeof e.pageX !== "undefined") {
      ...
      e.touches &&
      e.touches[0] &&
      typeof e.touches[0].clientX !== "undefined"
    ) {
